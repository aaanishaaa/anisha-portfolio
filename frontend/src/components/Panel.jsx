...
function Panel() {
  return (
    <div className="flex items-center justify-center bg-white px-6 py-5 w-full shadow-lg border-t-4 border-white relative overflow-hidden">
      ...
      <div className="flex items-center space-x-10 relative z-23 ">
        {/* Grid/Menu Icon */}
        <div className="flex-shrink-0">
          <div className="bg-white p-3 rounded-md shadow-md hover:shadow-lg transition-shadow cursor-pointer border border-gray-200 hover:scale-110 transition-transform duration-200">
        ...
        <div>
          ...
          <div className='flex items-center space-x-8 m-2'>
            <img src={cd} alt="CD Icon" className="w-18 h-10 transition-transform duration-200 hover:scale-150 cursor-pointer" />
            <img src={disk} alt="Disk Icon" className="w-18 h-10 transition-transform duration-200 hover:scale-150 cursor-pointer" />
            <img src={comp} alt="Computer Icon" className="w-18 h-10 transition-transform duration-200 hover:scale-150 cursor-pointer" />
          </div>
        </div>
      </div>
    </div>
