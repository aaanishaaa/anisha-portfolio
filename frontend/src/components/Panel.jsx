...
function Panel() {
  ...
  return (
    <div className="flex items-center justify-center bg-white w-full shadow-lg py-1 sm:py-2 md:py-3 lg:py-4 border-t-4 border-white relative overflow-hidden">
      ...
      <div className="flex items-center justify-between space-x-1 sm:space-x-2 md:space-x-3 lg:space-x-4 relative z-20 w-full max-w-7xl px-2 sm:px-3 md:px-4 lg:px-6">
        ...
        {/* Search bar */}
        <div className="flex-1 min-w-0 max-w-[120px] xs:max-w-[150px] sm:max-w-[200px] md:max-w-[300px] lg:max-w-[400px] xl:max-w-[480px]">
          <div className="flex items-center bg-white w-full px-2 sm:px-3 md:px-4 py-1 sm:py-1.5 md:py-2 rounded-full shadow-lg border-2 border-pink-200 hover:border-pink-300 transition-colors">
            <div className="text-orange-400 mr-1 sm:mr-2 flex-shrink-0">
            ...
            <input
              type="text"
              placeholder="Search..."
              className="flex-1 bg-transparent outline-none text-xs sm:text-sm md:text-base text-gray-700 placeholder-gray-400 font-medium min-w-0 w-full"
            />
          </div>
        </div>
       ...
       { /* Retro Action Icons */}
          <div className="flex-shrink-0">
            <div className="flex items-center space-x-1 sm:space-x-2 md:space-x-3 lg:space-x-4">
              {/* Resume CD - Always visible but different sizes */}
              <img
                src={cd}
                alt="Resume CD"
                className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-7 lg:h-7 xl:w-8 xl:h-8 opacity-80 hover:scale-125 transition-transform cursor-pointer"
                onClick={() => setShowResume(true)}
              />
              {/* Terminal Code - Hidden on very small screens */}
              <img
                src={code}
                alt="Terminal"
                className="hidden sm:block w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-7 lg:h-7 xl:w-8 xl:h-8 opacity-80 hover:scale-125 transition-transform cursor-pointer"
      ...
      {/* Resume Modal */}
      {showResume && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-1 sm:p-2 md:p-4">
          <div className="draggable-window retro-window bg-gradient-to-br from-gray-200 to-gray-300 border-4 border-gray-400 shadow-2xl w-[98%] sm:w-[95%] max-w-4xl flex flex-col font-mono relative scanlines max-h-[98vh] sm:max-h-[95vh] overflow-hidden">
            
            {/* Window Title Bar */}
            <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 flex items-center justify-between border-b-2 border-gray-500">
              <div className="flex items-center space-x-1 sm:space-x-2">
                <svg className="w-3 h-3 sm:w-4 sm:h-4" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z" clipRule="evenodd" />
                </svg>
                <span className="font-bold text-xs sm:text-sm truncate">Resume - Anisha_resume.pdf</span>
              </div>
              <div className="flex space-x-1">
                <button className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 bg-gray-300 hover:bg-gray-400 border border-gray-500 flex items-center justify-center retro-button">
              ...
              <div className="flex justify-center">
                <div className="bg-white shadow-lg border border-gray-300 w-full max-w-4xl">
                  ...
                  <iframe
                    ...
                    width="100%"
                    height="400px"
                    className="sm:h-[500px] md:h-[600px] lg:h-[700px] border-none"
            ...
            {/* Status Bar */}
            <div className="bg-gray-200 border-t border-gray-400 px-2 sm:px-3 md:px-4 py-1 text-xs text-gray-600 flex justify-between items-center">
              <span>Ready</span>
